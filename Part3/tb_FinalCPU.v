...
module tb_FinalCPU;
	...
	wire[4:0] RdAddr_MEM, RdAddr_WB, RsAddr_EX, RtAddr_EX;
	wire RegWrite_MEM, RegWrite_WB;
	assign ForwardA = UUT.FU.ForwardA;
	assign ForwardB = UUT.FU.ForwardB;
	assign RdAddr_MEM = UUT.FU.RdAddr_MEM;
	assign RdAddr_WB = UUT.FU.RdAddr_WB;
	assign RsAddr_EX = UUT.FU.RsAddr_EX;
	assign RtAddr_EX = UUT.FU.RtAddr_EX;
	assign RegWrite_MEM = UUT.FU.RegWrite_MEM;
	assign RegWrite_WB = UUT.FU.RegWrite_WB;
	initial
	begin : Preprocess
		// Initialize inputs
		AddrIn	= 32'd0;
